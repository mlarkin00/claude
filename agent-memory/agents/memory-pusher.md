---
name: memory-pusher
description: "Push local memory changes to GitHub. Use when the user asks to manually sync memory to GitHub, or when an automatic push may have failed. Examples:"
