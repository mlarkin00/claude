...
name: memory-puller
description: |
  Pull the latest memory state from GitHub. Use when the user asks to refresh memory from GitHub, or when you need to manually trigger a memory sync. Examples:
